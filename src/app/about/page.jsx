      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            ...
            {/* BIOGRAPHY DESC */}
            <p className="text-lg">
              Hi there! I&apos;m Lewis Odero, a dedicated fullstack software
              ddeveloper passionate about crafting exceptional digital
              experiences. With a solid foundation in computer science and a
              love for innovation, I thrive on bringing ideas to life through
              code. I specialize in both front-end and back-end development,
              navigating through languages like JavaScript, Python, and Java,
              and mastering frameworks such as React, Django, and Spring.
              Whether it&apos;s designing intuitive user interfaces or
              architecting scalable backend systems, I pour my heart into every
              project. Beyond coding, I&apos;m an avid explorer of emerging
              technologies and a firm believer in the power of user-centric
              design. When I&apos;m not buried in lines of code, you&apos;ll
              find me soaking up the latest tech trends or seeking inspiration
              in nature&apos;s beauty.
            </p>
            {/* BIOGRAPHY QUOTE */}
            <span className="italic">
              Embrace the journey of constant learning and innovation, for
              therein lies the beauty of becoming...
            </span>
            {/* BIOGRAPHY SIGN SVG*/}
            ...
            >
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                    I was mentored by a senior developer.{" "}
                  </div>
                  {/* JOB DATE */}
                  <div className="p-3 text-red-400 text-sm font-semibold">
                    2022 - 2024{" "}
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                    -&gt; Incorporated online payment functionality,
                    contributing to a 25% decrease in payment processing time
                    and a 20% reduction in billing errors.
                    <br />
                    -&gt; Implemented SEO strategies that increased the
                    clinic&apos;s online visibility, resulting in a 10% rise in
                    website traffic and new patient inquirie{" "}
                  </div>
                  {/* JOB DATE */}
                  <div className="p-3 text-red-400 text-sm font-semibold">
                    2020 - 2022{" "}
